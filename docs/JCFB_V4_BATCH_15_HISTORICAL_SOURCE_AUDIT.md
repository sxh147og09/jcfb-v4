...
|---|---|---|---|---|---|---|
| `F:\Projects\jcfb-v4\approved_data\historical_source_archive\` | `NOT FOUND` | approved archive location | none observed | not available | not available | `UNKNOWN` |
...
design-only migration files, but no historical match/result population,
official odds archive, external market archive, Team Context revision archive,
Evidence Graph revision archive, or BATCH-14 Gate Record population. Design
schemas and test fixtures are not source records.
